...
export const authorSchema: GraphQLObjectType = new GraphQLObjectType({
  name: "Author",
...
export const authorQuery: GraphQLObjectType = new GraphQLObjectType({
  name: "Query",
  fields: {
    authors: {
...
export const authorMutation: GraphQLObjectType = new GraphQLObjectType({
  name: "Mutation",
  fields: {
    author: {
      type: authorSchema,
